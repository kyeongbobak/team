        ...
        <form className="flex flex-col border-[1px] rounded-[4px] border-[#c4c4c4] p-[35px] " action="">
          <div className="flex flex-col">
            ...
            <div className="flex gap-[8px]">
              <input className="grow custom-signup-input placeholder: text-md" type="text" />
          ...
          <div className="flex flex-col">
            ...
            <input className="custom-signup-input placeholder: text-md" type="password" />
          </div>
          <div className="flex flex-col">
            <label className="py-[12px] text-md" htmlFor="">
              Name
            </label>
            <input className="custom-signup-input placeholder: text-md" type="text" />
          </div>
